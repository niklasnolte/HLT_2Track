...
class Locations:
    ...
    onetrack_ptshift = join(
        dirs.results, "ptshift_{data_type}_{presel_conf}_onetrack.txt",
    )
    onetrack_target_effs = join(
        dirs.results_eff, "target-eff_{data_type}_{presel_conf}_onetrack.pkl",
    )
    onetrack_full_effs = join(
        dirs.results_eff, "full-eff_{data_type}_{presel_conf}_onetrack.pkl",
    )
    onetrack_rate_vs_eff = join(
        dirs.scatter, "rate_vs_eff_{data_type}_{presel_conf}_onetrack.pdf",
    )
...
evttypes = list(
    {
        11102001: "Bd_K+pi-=DecProdCut",
        11102202: "Bd_Kstgamma=HighPtGamma,DecProdCut",
        11102405: "Bd_pi+pi-pi0=TightCuts,sqDalitz",
        11104020: "Bd_phiKst0=DecProdCut",
        11104041: "Bd_Kst0rho0,K+pi-pi+pi-=DecProdCut",
        11110010: "Bd_Ksttaumu,3pi=DecProdCut,tauolababar,phsp",
        11112001: "Bd_mumu=DecProdCut",
        11114018: "Bd_ppbarmumu=DecProdCut",
        11114041: "Bd_4mu=PHSP,DecProdCut",
        # 11114076: "Bd_KstarDarkBoson2MuMu,m=2500MeV,t=100ps,DecProdCut",
        # 11114078: "Bd_KstarDarkBoson2MuMu,m=2500MeV,t=10ps,DecProdCut",
...
# either only magup or only magdown exist here
# TODO use magup as well
diff = {
    12167181,
    11114002,
    11584032,
