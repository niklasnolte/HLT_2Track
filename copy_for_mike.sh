...
#results
cp results/eff_table_minipchi2+sumpt_lhcb_unnormed_heavy-flavor_svPT:1000+trkPT:200+svchi2:20+ipcuttrain:6_max-norm_direct_vector.txt for_mike/2d/eff_table_withipcut.txt
cp results/eff_table_minipchi2+sumpt_lhcb_unnormed_heavy-flavor_svPT:1000+trkPT:200+svchi2:20+ipcuttrain:10_max-norm_direct_vector.txt for_mike/2d/eff_table_noipcut.txt
...
#results
cp results/eff_table_fdchi2+sumpt+vchi2+minipchi2_lhcb_unnormed_heavy-flavor_svPT:1000+trkPT:200+svchi2:20+ipcuttrain:6_max-norm_direct_vector.txt for_mike/4d/eff_table_withipcut.txt
cp results/eff_table_fdchi2+sumpt+vchi2+minipchi2_lhcb_unnormed_heavy-flavor_svPT:1000+trkPT:200+svchi2:20+ipcuttrain:10_max-norm_direct_vector.txt for_mike/4d/eff_table_noipcut.txt
