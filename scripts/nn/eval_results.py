...
print("acc regular {:.6f}".format(max([balanced_accuracy_score(Y_truth, Y > i) for i in np.linspace(0,1,50)])))
print("acc sigma   {:.6f}".format(max([balanced_accuracy_score(Y_truth, Y_sigma > i) for i in np.linspace(0,1,50)])))
if feynman:
  print("acc feynman {:.6f}".format(max([balanced_accuracy_score(Y_truth, Y_feynman > i) for i in np.linspace(0,1,50)])))
